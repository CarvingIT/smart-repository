        ...
        <div class="col-md-9">
			...
			<option value="">Select Template</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                      <input class="form-control{{ $errors->has('html_code') ? ' is-invalid' : '' }}" name="html_code" id="input-email" type="text" placeholder="{{ __('Html Code') }}" value="{{ old('Html Code') }}" required />
