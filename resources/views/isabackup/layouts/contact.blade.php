...
<body>
  ...
  <div class="top-bar">
    <div class="container-fluid container-xl d-flex justify-content-end align-items-center">
      ...
      <div class="top-bar-link help-icon social-media-header">
        <a href="#"><i class="fa-solid fa-handshake-angle"></i></a>
      </div>
    </div>
  </div>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <!-- <li class="dropdown"><a href="javascript:void(0)"><span>Database</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="javascript:void(0)">Drop Down 1</a></li>
              <li class="dropdown"><a href="javascript:void(0)"><span>Deep Drop Down</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
