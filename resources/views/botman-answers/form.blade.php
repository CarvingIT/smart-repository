        ...
        <div class="col-md-9">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add Record') }}</h4>
              ...
              <div class="card-body">
                ...
                <div class="form-group row bmd-form-group">
                  ...
                  <div class="col-md-8">
                      <input class="form-control{{ $errors->has('question') ? ' is-invalid' : '' }}" name="question" id="question" type="text" placeholder="{{ __('Question') }}" value="{{ old('question') }}" required="true" aria-required="true"/>
                ...
                <div class="form-group row bmd-form-group">
                  ...
                  <div class="col-md-8">
					  <textarea name="answer" style="width:100%;" rows="10">
						{{ old('answer') }}
					  </textarea>
