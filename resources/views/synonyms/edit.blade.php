            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <div class="form-group row bmd-form-group">
                  <div class="col-md-4">
                  <label class="col-md-8 col-form-label text-md-right">{{ __('Synonym Name') }}</label>
                  </div>
                  <div class="col-md-6">
                      <input class="form-control{{ $errors->has('synonym') ? ' is-invalid' : '' }}" name="synonym" id="input-synonym" type="text" placeholder="{{ __('Synonym Name') }}" value="{{ old('synonym', $synonym->synonym) }}" required="true" aria-required="true"/>
