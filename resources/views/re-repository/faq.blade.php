        ...
        <div class="col-md-12">
            ...
            <div class="card-header card-header-primary">
				...
				<br>
                            ...
                            <p class="strong">What is the aim of the Regulation Repository?</p>
                            <p>
                            ...
                            <p class="strong">Who are the stakeholders of the Repository?
                            </p>
                            <p>
                            ...
                            <p class="strong">What resource types are available in Repository?
                            </p>
                            <p>
                            ...
                            <p class="strong">How do I navigate the Repository?
                            </p>
                            <p>
                            ...
                            <p class="strong">A document that would be relevant to the repository is not uploaded here. How can I inform/share it?
                            </p>
                            <p>
                            ...
                            <p class="strong">I want to collaborate and write an opinion piece. How do I do it?
                            </p>
                            <p>
                            ...
                            <p class="strong">I have a query that is not listed here. How do I address it?
                            </p>
                            <p>
