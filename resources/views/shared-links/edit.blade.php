                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('permission_level') ? ' has-danger' : '' }}">
                    <select class="form-control{{ $errors->has('permission_level') ? ' is-invalid' : '' }}" name="permission_level" id="input-permission_level">
                        <option value="view" {{ $sharedLink->permission_level == 'view' ? 'selected' : '' }}>View Only</option>
                        <option value="download" {{ $sharedLink->permission_level == 'download' ? 'selected' : '' }}>View and Download</option>
                        <option value="both" {{ $sharedLink->permission_level == 'both' ? 'selected' : '' }}>View and Download (same as above)</option>
                    </select>
