...
//print_r($allQueryParams);
$collection_id = $allQueryParams['collection_id'];
//echo $collection_id;
//echo auth()->user();
$collection = \App\Collection::find($collection_id);
$column_config = json_decode($collection->column_config);
//print_r($column_config);
//echo $column_config->pdf_viewer;
//echo $column_config->document_viewer_download;
if(auth()->user()->hasPermission($collection_id,'MAINTAINER')){
//echo "SKK";
}
else{
//echo 'NoPermission';
    ...
    <head>
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                // Wire up highlight thickness slider
                    ...
                    thicknessSlider.addEventListener("input", function () {
                        if (
                            ...
                            window.PDFViewerApplication.eventBus.dispatch(
                                ...
                                {
                                    source: thicknessSlider,
                                    type: 22, // INK_THICKNESS (best match available)
                ...
                // Wire up "Show all" iOS-style toggle
                ...
                if (showAllBtn) {
                    showAllBtn.addEventListener("click", function () {
                        ...
                        // Toggle visibility of all highlight annotations
                        if (
                            window.PDFViewerApplication &&
                ...
                >
                    ...
                    >
                        ...
                        <div id="editorHighlightVisibility">
                            <div class="highlightDivider"></div>
                            <div class="highlightToggler">
                                <label
                    ...
                    <div id="secondaryToolbarButtonContainer">
                        ...
                        <button
                            id="secondaryDownload"
                             @if(auth()->user() && auth()->user()->hasPermission($collection_id,'MAINTAINER') || !empty($column_config->document_viewer_download))
                            class="secondaryToolbarButton visibleMediumView"
                            title="Save"
                            tabindex="53"
